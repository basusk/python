...
###### Revision 4 : Except from modifying optimize model API response parsing, remaining logic is unchanged; Date:  9th 2023 ############# 
...
config.readfp(open(r'cfg_model_create_v4.ini'))
